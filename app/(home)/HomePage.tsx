...
export default function HomePage({ numStars }: { numStars: string }) {
  ...
  const cardItems = [
    {
      title: "Next.js 13",
      description: "App directory, routing, layouts, and API routs.",
      footer: "Next.js 13 documentation",
    ...
    },
    {
      ...
      footer: "PostgreSQL documentation",
    ...
    {
      title: "Components",
      description: "UI components built with NextUI. Dark mode implemented using next-themes.",
      ...
      svg: (
        <svg
          ...
          style={{ height: 32 }}
        >
          <g id="Group_1" data-name="Group 1" transform="transform(-773 -353)">
            <rect
              id="Rectangle_1"
    ...
    {
      title: "Tailwind CSS",
      description: "Utility-first CSS framework enabling rapid and customizable front-end styling.",
    ...
    },
    {
      ...
      description: "OAuth 2.0 authentication through Google, Github and Discord using NextAuth.js.",
      ...
      svg: (
        <svg
          ...
          strokeWidth="1"
          className="h-12 w-12 fill-content"
          style={{ height: 32 }}
          fill={theme === "dark" ? "#FFFFFF" : "#100F13"}
        >
    ...
    {
      title: "OpenAI API",
      description: "Uses GPT-3.5-Turbo model from OpenAI to enhance social media posts.",
      footer: "OpenAI documentation",
    ...
    {
      title: "Payments",
      description: "Paid subscriptions using Stripe unlocking features for users.",
    ...
    <div className="container mx-auto p-4 max-w-7xl">
      ...
      <div className="space-y-4 text-center">
        ...
        <h2 className="text-2xl font-medium">
          This is an app built to showcase capabilities of Next.js 13.
        </h2>
        ...
        <User
          ...
          description={
            <Link className="text-small" href="https://github.com/MikeGolden">
              github.com/MikeGolden
            </Link>
          }
          avatarProps={{
            src: "https://avatars.githubusercontent.com/u/3935535",
          }}
          onClick={() => window.open("https://github.com/MikeGolden")}
        />
